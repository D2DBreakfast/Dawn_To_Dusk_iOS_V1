...
//  AttachmentHandler
//
//  Created by Hiren Joshi on 25/01/18.
//  Copyright © 2018 Hiren Joshi. All rights reserved.
//
...
@objc public class AttachmentHandler: NSObject, UINavigationControllerDelegate {
    static let shared = AttachmentHandler()
    fileprivate var currentVC: UIViewController?
    
    //MARK: - Internal Properties
    @objc public var imagePickedBlock: ((UIImage) -> Void)?
    @objc public var videoPickedBlock: ((NSURL) -> Void)?
    @objc public var filePickedBlock: ((URL) -> Void)?
    ...
    public struct Constants {
        ...
        static let phoneLibrary = "Phone Library".localized()
        ...
        static let alertForFileLibraryMessage = "App does not have access to your files. To enable access, tap settings and turn on Document Access.".localized()
    ...
    @objc public func showAttachmentActionSheet(vc: UIViewController) {
        currentVC = vc
    ...
    public func ShowSelectedAttachOption(vc: UIViewController, constant: [AttachmentType]) {
    ...
    public func authorisationStatus(attachmentTypeEnum: AttachmentType, vc: UIViewController){
        currentVC = vc
    ...
    //MARK: - SETTINGS ALERT
    public func addAlertForSettings(_ attachmentTypeEnum: AttachmentType){
        ...
        if attachmentTypeEnum == AttachmentType.file{
            alertTitle = Constants.alertForFileLibraryMessage
        }
...
extension AttachmentHandler: UIImagePickerControllerDelegate {
